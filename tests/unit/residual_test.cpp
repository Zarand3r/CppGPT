...
int main() {
    ...
    residual_forward(out.data(), a.data(), b.data(), N, Device::CPU);
    bool fwd_ok = true;
    ...
    residual_forward(a2.data(), a2.data(), b.data(), N, Device::CPU);
    ...
    residual_backward(da.data(), db.data(), dout.data(), N, Device::CPU);
    bool bwd_ok = true;
