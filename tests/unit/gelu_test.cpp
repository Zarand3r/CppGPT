...
int main() {
    ...
    // ---- backward: finite-difference gradient check ----
    {
        ...
        gelu_backward(dinp.data(), inp.data(), dout.data(), N);  // analytic
        ...
        gelu_backward(dinp2.data(), inp.data(), dout.data(), N);
        bool doubled = true;
        for (int i = 0; i < N; ++i)
